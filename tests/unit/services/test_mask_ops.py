...
class TestMaskOperations:
    ...
    def test_expand_neuron_mask_to_weights_linear(self):
        ...
        expanded = MaskOperations.expand_neuron_mask_to_weights(
            neuron_mask, weight_shape, dim=0
        )
    ...
    def test_global_threshold_mask(self):
        ...
        layer_scores = {
            'layer1': torch.tensor([0.1, 0.5, 0.3]),
            'layer2': torch.tensor([0.9, 0.2, 0.8, 0.4])
        }
