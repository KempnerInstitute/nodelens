...
from nodelens.core.base import BaseModel

from .hooks import HookManager

# Conditional import for layer detector (graceful fallback)
try:
    from nodelens.core.layer_detector import detect_trackable_layers
...
class BaseModelWrapper(BaseModel):
    ...
    def _discover_layers(self) -> List[str]:
        """
        Auto-discover layers that can be tracked by NodeLens.
    ...
    def preprocess_activations(self, activations: Dict[str, torch.Tensor], mode: str = "flatten") -> Dict[str, torch.Tensor]:
        ...
        use the data processing module: nodelens.data.processing.preprocess_layer_activations
