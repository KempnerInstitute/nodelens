...
```python
from nodelens.analysis.clustering import MetricSpaceClustering, CrossLayerHaloAnalysis
...
```python
from nodelens.analysis import CascadeAnalysis
...
```python
from nodelens.analysis.visualization import plot_metric_scatter, plot_cluster_evolution
