...
from nodelens.models.transformers import TransformerWrapperEnhanced as TransformerWrapper
from nodelens.pruning import AlignmentPruning, PruningConfig
from nodelens.pruning.pipeline import PruningPipelineOptions
from nodelens.pruning.strategies.llm_baselines import SparseGPTPruning, WandaPruning
from nodelens.services import MaskOperations
...
class LLMAlignmentExperiment(BaseExperiment):
    ...
    def setup(self):
        ...
        if needs_text_dataset:
            try:
                from nodelens.dataops.datasets.text_datasets import load_text_dataset
        ...
        for layer_name in self.wrapped_model._tracked_layers:
            ...
            for metric_name in metric_names:
                if "redundancy" in metric_name or "synergy" in metric_name:
                    logger.debug("Skipping pairwise metric %s in the independent LLM scoring pass", metric_name)
                    continue
    ...
    def compute_baseline_pruning_scores(
        ...
        try:
            ...
            from nodelens.dataops.datasets.text_datasets import WikiTextDataset
        ...
        if "owl" in strategies:
            ...
            try:
                from nodelens.pruning.strategies.llm_baselines import OWLPruning
        ...
        if "llm_pruner" in strategies:
            ...
            try:
                from nodelens.pruning.strategies.llm_baselines import LLMPrunerChannelMode
        ...
        if "flap" in strategies:
            ...
            try:
                from nodelens.pruning.strategies.llm_baselines import FLAPPruning
        ...
        if "ria" in strategies:
            ...
            try:
                from nodelens.pruning.strategies.llm_baselines import RIAPruning
        ...
        if "slimllm" in strategies:
            ...
            try:
                from nodelens.pruning.strategies.llm_baselines import SlimLLMPruning
                ...
                try:
                    ...
                    try:
                        ...
                        if isinstance(rh_cfg, dict) and bool(rh_cfg.get("enabled", False)):
                            from nodelens.analysis.read_halo_llm import ReadHaloConfig, compute_next_layer_read_halo
    ...
    def apply_pruning(self, sparsity: float = 0.2, metric: str = "activation_l2_norm", mode: str = "low") -> Dict[str, torch.Tensor]:
        ...
        from nodelens.pruning.base import PrecomputedScorePruning
    ...
    def run(self) -> Dict[str, Any]:
        ...
        if getattr(self.config, "generate_plots", True):
            try:
                from nodelens.analysis.visualization.llm_mechanism_plots import (
