...
The BROJA solver is optional. When `dit` with BROJA support is installed, these
metrics discretize the inputs and compute the requested PID component. Without
that optional dependency, they return zero scores and log a warning. For the
fast Gaussian approximation used in most experiments, use
