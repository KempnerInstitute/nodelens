...
from nodelens.dataops.datasets.unified_dataset import DATASET_CONFIGS, UnifiedDataset

# Try to import text datasets (optional - requires additional dependencies)
try:
    from nodelens.dataops.datasets.text_datasets import C4Dataset, TextDataset, WikiTextDataset, load_text_dataset
