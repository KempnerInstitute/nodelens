...
```python
from nodelens.pruning import MagnitudePruning, PruningConfig
...
```python
from nodelens.pruning import EigenvectorPruning, PruningConfig
...
```python
from nodelens.pruning import MovementPruning
...
```python
from nodelens.pruning import AdaptiveSensitivityPruning
...
```python
from nodelens.pruning import CascadingAlignmentPruning, PruningConfig
...
```python
from nodelens.pruning import run_pruning_pipeline, PruningPipelineOptions
