...
try:
    ...
    class CHIPPruning:  # type: ignore
        def __init__(self, *args, **kwargs):
            raise ImportError("CHIPPruning is unavailable: missing `nodelens.pruning.strategies.chip`.")

    def compute_chip_scores(*args, **kwargs):  # type: ignore
        raise ImportError("compute_chip_scores is unavailable: missing `nodelens.pruning.strategies.chip`.")

    def chip_score_channels(*args, **kwargs):  # type: ignore
        raise ImportError("chip_score_channels is unavailable: missing `nodelens.pruning.strategies.chip`.")
