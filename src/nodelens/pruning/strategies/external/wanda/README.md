...
- Our comparisons use **channel-adapted baselines** implemented in `src/nodelens/pruning/strategies/llm_baselines.py`.
...
- `src/nodelens/pruning/strategies/external/wanda/data.py`
- `src/nodelens/pruning/strategies/external/wanda/layerwrapper.py`
- `src/nodelens/pruning/strategies/external/wanda/prune.py`
