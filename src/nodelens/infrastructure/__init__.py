...
- Configuration: See nodelens.configs for the main config system
...
Example:
    ...
    >>> from nodelens.infrastructure import setup_logging, get_logger
    >>> from nodelens.infrastructure.storage import create_job_directory
"""
