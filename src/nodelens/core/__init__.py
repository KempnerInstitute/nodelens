...
Example - Using registered components:
    ...
    from nodelens.core import get_metric, METRIC_REGISTRY
...
from .protocols import AlignmentMetric, Analyzer, AnalyzerConfig, BaseAnalyzer
from .protocols import BaseMetric as BaseMetricProtocol  # New protocols for enhanced modularity; Base classes from protocols; Config dataclasses
from .protocols import BasePruner, DatasetWrapper, Evaluator, Experiment, MetricAggregator, MetricConfig
from .protocols import ModelWrapper as ModelWrapperProtocol
from .protocols import Preprocessor, Pruner, PrunerConfig, ResultReporter, Visualizer

# Registry system
from .registry import (  # Core registry class; Global registries; Registration decorators; Getter functions; Unified factory functions; Discovery
    AGGREGATOR_REGISTRY,
    ALL_REGISTRIES,
    ANALYZER_REGISTRY,
    DATASET_REGISTRY,
