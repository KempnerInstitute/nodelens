...
class EigenvectorPruning(BasePruningStrategy):
    ...
    Examples:
        >>> from alignment.pruning.strategies import EigenvectorPruning
    ...
    def _compute_activation_covariance(
        self, 
    ...
    def compute_importance_scores(
        ...
        **kwargs
        ...
        logger.debug(f"Eigenvalue importance: min={neuron_scores.min():.4f}, "
                    f"max={neuron_scores.max():.4f}, mean={neuron_scores.mean():.4f}")
