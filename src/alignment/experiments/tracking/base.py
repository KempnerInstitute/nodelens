...
class WandBTracker(ExperimentTracker):
    ...
    def __init__(
        ...
        try:
            ...
            self.wandb = wandb
            self.run = wandb.init(project=project, entity=entity, name=experiment_name, config=config, tags=tags or [])
            self.enabled = True
    ...
    def log_alignment_scores(self, layer_scores: Dict[str, Dict[str, torch.Tensor]], step: Optional[int] = None):
...
class TensorBoardTracker(ExperimentTracker):
    ...
    def __init__(self, experiment_name: str, config: Dict[str, Any], log_dir: str = "./runs"):
        super().__init__(experiment_name, config)
...
def create_tracker(tracker_type: str, experiment_name: str, config: Dict[str, Any], **kwargs) -> ExperimentTracker:
    """
