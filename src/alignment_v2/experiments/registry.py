...
from alignment_v2.experiments.alignment_comparison import AlignmentComparison
from alignment_v2.experiments.adversarial_shaping import AdversarialShaping

EXPERIMENT_REGISTRY = {
    "alignment_info_stats": AlignmentStatisticsInfo,
