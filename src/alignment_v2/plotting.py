...
def plot_dropout_results(exp, dropout_results, dropout_parameters, prms, dropout_type="nodes"):
    ...
    acc_mean_diff, acc_se_diff = compute_stats_by_type(dropout_results["progdrop_acc_high"]-dropout_results["progdrop_acc_low"], num_types=num_types, dim=0, method="se")
