...
from alignment_refac1.metrics import compute_metrics_for_layers # NEW
from alignment_refac1.utils.activation_utils import collect_layer_data # NEW
from alignment_refac1.models import AlignmentNetwork # Assuming AlignmentNetwork is in alignment.models
from alignment_refac1.config import BaseConfig # For accessing global config settings
