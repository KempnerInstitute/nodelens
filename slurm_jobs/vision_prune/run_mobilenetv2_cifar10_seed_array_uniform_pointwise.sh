#!/bin/bash
#SBATCH --job-name=vision_mbv2_cifar10_uniform_pw_seed
#SBATCH --output=logs/vision_mbv2_cifar10_uniform_pw_seed_%A_%a.out
#SBATCH --error=logs/vision_mbv2_cifar10_uniform_pw_seed_%A_%a.err
#SBATCH --nodes=1
...
# ----------------------------------------------------------------------------
# MobileNetV2 / CIFAR-10: uniform distribution + pointwise-only pruning (3 seeds)
# ----------------------------------------------------------------------------
