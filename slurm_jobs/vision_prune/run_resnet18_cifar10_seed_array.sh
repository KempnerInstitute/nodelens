#!/bin/bash
#SBATCH --job-name=vision_r18_cifar10_seed
#SBATCH --output=logs/vision_r18_cifar10_seed_%A_%a.out
#SBATCH --error=logs/vision_r18_cifar10_seed_%A_%a.err
#SBATCH --nodes=1
...
# ----------------------------------------------------------------------------
# ResNet-18 / CIFAR-10: multi-seed final runs (3 seeds)
# ----------------------------------------------------------------------------
...
echo "============================================================================"
echo "Vision Paper (final): ResNet-18/CIFAR-10 seed=${SEED}"
echo "============================================================================"
