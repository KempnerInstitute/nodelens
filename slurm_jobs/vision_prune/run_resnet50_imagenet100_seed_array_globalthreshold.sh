#!/bin/bash
#SBATCH --job-name=vision_r50_imnet100_gth_seed
#SBATCH --output=logs/vision_r50_imnet100_gth_seed_%A_%a.out
#SBATCH --error=logs/vision_r50_imnet100_gth_seed_%A_%a.err
#SBATCH --nodes=1
...
# ----------------------------------------------------------------------------
# ResNet-50 / ImageNet-100: global_threshold + per-layer cap (2 seeds, PAPER)
# ----------------------------------------------------------------------------
...
echo "============================================================================"
echo "Vision Paper: ResNet-50/ImageNet-100 (GLOBAL_THRESHOLD) seed=${SEED}"
echo "============================================================================"
...
python scripts/run_experiment.py \
  --config configs/vision_prune/resnet50_imagenet100_unified_paper_globalthreshold.yaml \
  --device cuda \
  --seed "${SEED}" \
