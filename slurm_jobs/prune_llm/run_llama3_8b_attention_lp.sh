#!/bin/bash
#SBATCH --job-name=paper_llama3_attn_lp
#SBATCH --output=logs/paper_llama3_attn_lp_%j.out
#SBATCH --error=logs/paper_llama3_attn_lp_%j.err
#SBATCH --nodes=1
...
# ============================================================================
# LLaMA-3.1-8B ATTENTION LP ANALYSIS
# ============================================================================
# Purpose:
# - Compute SCAR-style loss proxy metrics for attention heads
# - Compare concentration to FFN channels
# - Determine if supernode-halo structure extends to attention
# ============================================================================

set -euo pipefail

echo "============================================================================"
echo "SCAR Paper: Attention LP Analysis | LLaMA-3.1-8B"
echo "============================================================================"
...
python scripts/run_experiment.py \
  ...
  name="llama3_8b_paper_results_attention_lp" \
  generate_plots=true \
...
echo ""
echo "============================================================================"
echo "Attention LP analysis completed at $(date)"
echo "============================================================================"
