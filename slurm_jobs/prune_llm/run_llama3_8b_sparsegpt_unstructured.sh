#!/bin/bash
#SBATCH --job-name=paper_llama3_sparsegpt_unstruct
#SBATCH --output=logs/paper_llama3_sparsegpt_unstruct_%j.out
...
# ============================================================================
# LLaMA-3.1-8B PAPER-FAITHFUL BASELINE: SparseGPT (UNSTRUCTURED + RECONSTRUCTION)
# ============================================================================
# Purpose:
# - Run SparseGPT as originally intended (unstructured weight pruning with reconstruction),
#   as an appendix/sanity baseline, separate from the channel-adapted SparseGPT baseline.
#
# Notes:
# - This is NOT structured FFN channel pruning; it's unstructured weight pruning.
# - This is compute-heavy; we run a small setting by default (50% sparsity, mode=low, perplexity-only).
# ============================================================================

set -euo pipefail

echo "============================================================================"
echo "SCAR Paper Baseline (unstructured): SparseGPT | LLaMA-3.1-8B"
echo "============================================================================"
...
python scripts/run_experiment.py \
  ...
  name="llama3_8b_paper_results_sparsegpt_unstructured" \
  generate_plots=false \
  pruning_strategies="['sparsegpt_unstructured']" \
  pruning_amounts="[0.5]" \
...
echo ""
echo "============================================================================"
echo "SparseGPT unstructured baseline completed at $(date)"
echo "============================================================================"
