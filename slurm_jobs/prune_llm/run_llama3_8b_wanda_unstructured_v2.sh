...
# ============================================================================
# LLaMA-3.1-8B PAPER-FAITHFUL BASELINE: WANDA (UNSTRUCTURED) - V2
# ============================================================================
...
echo "============================================================================"
echo "SCAR Paper Baseline (unstructured): Wanda | LLaMA-3.1-8B (4xGPU)"
echo "============================================================================"
...
python scripts/run_experiment.py \
  ...
  name="llama3_8b_paper_results_wanda_unstructured_v2" \
  generate_plots=true \
